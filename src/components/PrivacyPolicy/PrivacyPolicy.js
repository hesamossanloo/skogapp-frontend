    ...
    <div className="page">
      <div className="header">
        <div className="container">
          <p className="title">Privacy Policy for SkogApp</p>
        </div>
      </div>
      <div className="translations-content-container">
        <div className="container">
          ...
          >
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to SkogApp AS,
                  Ringgata 4c, 0577 Oslo, Norway.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to SkogApp, accessible from
                  &nbsp;
                  <a
                    href="https://skogapp.no/"
            ...
            <ul>
              <li>By email: hesam@skogapp.no</li>
            </ul>
          </div>
        </div>
      </div>
